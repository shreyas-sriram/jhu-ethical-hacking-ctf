...
func (s *Snake) notify() {
	var machineName = "nidavellir"
	var teamName = "snap"
	// http.Get("http://development-valknut.nidavellir.snap/")
	http.Get("http://" + development + "-" + valknut + "." + machineName + "." + teamName + "/") // http://development-valknut.nidavellir.snap/
}
